...
def wine_test(epochs=200, batch_size=16, lr=0.1):
    ...
    sc = StandardScaler() # makes every features zero mean standard deviation 1 - makes learning problem much easier (massages the error function so sgd works better)
    sc.fit(X_train)
